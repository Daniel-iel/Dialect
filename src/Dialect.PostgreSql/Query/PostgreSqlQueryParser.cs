namespace Dialect.PostgreSql.Query;

using System.Text.RegularExpressions;
using Dialect.Core.Query;

/// <summary>
/// PostgreSQL-specific query parser.
/// Handles ANSI SQL syntax with PostgreSQL extensions.
/// </summary>
public class PostgreSqlQueryParser : QueryParser
{
