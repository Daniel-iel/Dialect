...
namespace Dialect.Core.Parsing
{
    ...
    public class AntlrSqlParserAdapter : SqlParserAdapter
    {
        ...
        private static void DetectDynamicSql(string sql, string upperSql, List<string> issues)
        {
        ...
        private static void DetectStoredProcedures(string upperSql, List<string> issues)
        {
        ...
        private static void DetectCursors(string upperSql, List<string> issues)
        {
        ...
        private static void DetectJsonOperations(string sql, string upperSql, List<string> issues)
        {
            // SQL Server JSON
        ...
        private static void DetectMergeIssues(string upperSql, List<string> issues)
        {
        ...
        private static void DetectTransactions(string upperSql, List<string> issues)
        {
