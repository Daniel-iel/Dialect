...
public class DialectIndexAdvisorTests
{
    ...
    public void SqlServerIndexAdvisor_GeneratesNonclusteredIndexes()
    {
        ...
        var query = "SELECT * FROM Products WHERE CategoryId = 5 AND IsActive = 1";
    ...
    public void PostgreSqlIndexAdvisor_GeneratesPartialIndexes()
    {
        ...
        var query = "SELECT * FROM Orders WHERE Status = 'pending' AND CreatedAt > NOW() - INTERVAL '30 days'";
    ...
    public void PostgreSqlIndexAdvisor_GeneratesBrinIndexes()
    {
        // Arrange
        var advisor = new PostgreSqlIndexAdvisor();
        var query = "SELECT * FROM events WHERE created_at > NOW() - INTERVAL '1 year'";
    ...
    public void MySqlIndexAdvisor_GeneratesCompositeIndexes()
    {
        ...
        var query = "SELECT * FROM orders WHERE customer_id = 5 AND status = 'completed' AND order_date > '2024-01-01'";
    ...
    public void IndexAdvisor_CalculatesRoiScore()
    {
        // Arrange
        var advisor = new SqlServerIndexAdvisor();
        var query = "SELECT * FROM LargeTable WHERE Id = 1";
...
public class DialectQueryRewriteAdvisorTests
{
    ...
    public void SqlServerRewriteAdvisor_SuggestsCTE()
    {
        ...
        var query = "SELECT * FROM (SELECT id FROM orders) o JOIN (SELECT id FROM customers) c ON o.id = c.id";
    ...
    public void PostgreSqlRewriteAdvisor_SuggestsMaterializedView()
    {
        ...
        var query = "SELECT COUNT(*) FROM orders o JOIN customers c ON o.customer_id = c.id WHERE c.status = 'active' GROUP BY c.region";
    ...
    public void MySqlRewriteAdvisor_SuggestsInToJoinConversion()
    {
        ...
        var query = "SELECT * FROM orders WHERE customer_id IN (SELECT id FROM customers WHERE status = 'active')";
    ...
    public void MySqlRewriteAdvisor_SuggestsBatchInsert()
    {
        // Arrange
        var advisor = new MySqlRewriteAdvisor();
        var query = "INSERT INTO products (name, price) VALUES ('Product 1', 100)";
    ...
    public void RewriteAdvisor_ProvidesImplementationPatterns()
    {
        // Arrange
        var advisor = new SqlServerRewriteAdvisor();
        var query = "SELECT * FROM (SELECT id FROM orders) sub";
